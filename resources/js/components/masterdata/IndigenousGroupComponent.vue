<template>
    <div class="p-2">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active text-black" aria-current="page">Indigenous Group</li>
        </ol>
        </nav>
                ...
                <div class="card" style="height: auto; ">
                    <div class="p-5">
                        <div class="form-group">
                            <label for="name">Indigenous Group</label>
                        ...
                        <div class="d-flex justify-content-end">
                            <div>
                                <div class="">
                                    <button v-if=" !isEdit" v-on:click="createRecord" type="button" class="btn btn-primary bg-blue">Add Group</button>
            ...
            <div class="col-md-8">
                <div class="card p-5" style="height: 83vh; overflow-y: scroll;">  
                    <div class="filter row align-items-center">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="region" class="form-label w-50">Indigenous Group</label>
...
export default{
  ...
  methods: {
    ...
    show() {
        this.isLoading = true;
        axios.get('/indigenousgroups/show').then(function (res) {
    ...
    filterData() {
        this.isLoading = true;
        axios.post('/indigenousgroups/filterData', {
    ...
    createRecord() {
        this.isLoading = true;
        axios.post('/indigenousgroups/store', {
            name : this.name,
        }).then(response => {
            this.$fire({
    ...
    updateRecord() {
        axios.put('/indigenousgroups/update/' + this.id, {
            name: this.name,
        })
        .then(response => {
    ...
    destroy(data) {
        if(confirm('Are you sure you want to delete this record?')) {
            ...
            axios.get('/indigenousgroups/destroy/' + data.row.id)
            .then(response => {
                // console.log(response);
                this.$fire({
