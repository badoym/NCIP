...
class WebUserGovernmentProgramController extends Controller
{
    public function index()
    {
        return view('webusers.governmentprogram');
    }
    public function show()
    {
        $data = ProgramServicesPool::leftJoin('government_programs', 'program_services_pools.government_program_id', 'government_programs.id')
            ...
            ->whereNotNull('program_services_pools.government_program_id')
    ...
    public function programApplied(){
    ...
    public function cancelProgramApplied($id){
